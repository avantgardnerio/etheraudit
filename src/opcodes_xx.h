...
XX(JUMPTO, 0xb0, 0, 0, 0)		///< alter the program counter to a jumpdest
XX(JUMPIF, 0xB1, 0, 0, 0)		///< conditionally alter the program counter
XX(JUMPSUB, 0xB2, 0, 0, 0)		///< alter the program counter to a beginsub
XX(JUMPV, 0xB3, 0, 0, 0)		///< alter the program counter to a jumpdest
XX(JUMPSUBV, 0xB4, 0, 0, 0)		///< alter the program counter to a beginsub
XX(BEGINSUB, 0xB5, 0, 0, 0)		///< set a potential jumpsub destination
XX(BEGINDATA, 0xB6, 0, 0, 0)		///< begine the data section
XX(RETURNSUB, 0xB7, 0, 0, 0)		///< return to subroutine jumped from
XX(PUTLOCAL, 0xB8, 0, 0, 0)		///< pop top of stack to local variable
XX(GETLOCAL, 0xB9, 0, 0, 0)		///< push local variable to top of stack
*/
